...
This series focuses on interviewing various users of the osu!community. In addition to this, there may be some group discussions about different things happening around the community such as changes to the staff, or long lasting issues often discussed like overmapping. The podcast series is set up so that anyone is free to join in on the live session and ask questions during the public [Q&A](https://en.wikipedia.org/wiki/Q%26A) part of the episode. These aren't live streamed anywhere as we'd rather encourage users to join in and take part themselves.
