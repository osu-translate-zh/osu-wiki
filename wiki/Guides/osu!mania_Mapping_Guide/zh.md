...
*See also [Mania](/wiki/Game_Modes/osu!mania)*
...
`Shift` + `Q` changes the Sample set to "Auto" `Shift` + `W` changes the Sample set to "Normal" `Shift` + `E` changes the Sample set to "Soft" `Shift` + `R` changes the Sample set to "Drum"

`CTRL` + `Q` changes the Additions to "Auto" `CTRL` + `W` changes the Additions to "Normal" `CTRL` + `E` changes the Additions to "Soft" `CTRL` + `R` changes the Additions to "Drum"

`W` gives your note the effect "Whistle" `E` gives your note the effect "Finish" `R` gives your note the effect "Clap"
